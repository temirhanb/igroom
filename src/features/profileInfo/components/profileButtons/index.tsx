import {useProfileButtonsHook} from "@/features/profileInfo/components/profileButtons/hook/useProfileButtonsHook";

export const ProfileButtons = () => {

  const {city} = useProfileButtonsHook();
  ...
  return (
    <div className={"mt-[18px] flex flex-row justify-between"}>
      ...
      >
        <span
          className={"leading-[28px] text-[22px] text-[#434343] font-normal"}>{city?.name === undefined ? "Краснодар" : city.name}</span>
      </button>
      <button
