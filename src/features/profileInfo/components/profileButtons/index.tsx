export const ProfileButtons = ()=>{
  return(
    <div className={"mt-[18px] flex flex-row justify-between"}>
      ...
      >
        <span className={"leading-[28px] text-[22px] text-[#434343] font-normal"}>Краснодар</span>
      </button>
      <button
        className={"rounded-[25px] border-[3px] text-[#A7A7A7] border-[#A7A7A7] bg-white h-[60px] w-[122px] flex items-center"}>
