import {useProfileStatisticHook} from "@/features/profileInfo/components/profileStatistic/hook/useProfileStatisticHook";

export const ProfileStatistic = () => {

  const {statisticInfo} = useProfileStatisticHook();
